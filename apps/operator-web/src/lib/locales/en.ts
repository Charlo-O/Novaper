export const en = {
  ...
  settings: {
    ...
    deviceManagementDesc: 'Manage wireless device connections and device groups',
    addWirelessDevice: 'Add Wireless Device',
    manageGroups: 'Manage Groups',
    apiConfiguration: 'API Configuration',
    apiConfigurationDesc: 'Configure vision model, decision model, and agent settings',
    openApiConfig: 'Open Configuration',
    general: 'General',
    generalDesc: 'Language, theme, version info and links',
    language: 'Language',
    theme: 'Theme',
    version: 'Version',
    github: 'GitHub',
  ...
  workflows: {
    ...
    recordNew: 'Record Workflow',
    recording: 'Recording',
    recordingStart: 'Start Recording',
    recordingStop: 'Stop Recording',
    recordingSave: 'Save Recording',
    recordingUrl: 'Starting URL',
    recordingUrlPlaceholder: 'https://example.com',
    recordingActions: 'Recorded Actions',
    recordingNoActions: 'No actions recorded yet. Interact with the page to record actions.',
    replay: 'Replay',
  ...
  plugins: {
    ...
    refresh: 'Refresh',
    repoManagement: 'Repo Management',
    searchPlaceholder: 'Search skill name or description...',
    filterAll: 'All',
    filterInstalled: 'Installed',
    filterNotInstalled: 'Not Installed',
    scanningRepos: 'Scanning repositories for skills...',
    noSkillsFound: 'No skills found.',
    discoveryErrors: 'Some repositories failed to load:',
    installedBadge: 'Installed',
    view: 'View',
    install: 'Install',
    uninstall: 'Uninstall',
    uninstallSkillTitle: 'Uninstall Skill',
    uninstallSkillConfirm: 'Are you sure you want to uninstall this skill?',
    // Repo manager dialog
    addRepo: 'Add Repository',
    noRepos: 'No repositories configured.',
    repoUrl: 'Repository',
    repoUrlPlaceholder: 'owner/repo or https://github.com/owner/repo',
    repoBranch: 'Branch',
    deleteRepoTitle: 'Delete Repository',
    deleteRepoConfirm: 'Are you sure you want to remove repository "{repo}"?',
    // MCP Servers
    mcpDescription: 'External tool servers connected via Model Context Protocol.',
    addMcpServer: 'Add MCP Server',
    editMcpServer: 'Edit MCP Server',
    noMcpServers: 'No MCP servers configured yet.',
    mcpName: 'Name',
    mcpNamePlaceholder: 'e.g., Filesystem Server',
    ...
    deleteMcpConfirm: 'Are you sure you want to delete this MCP server? This action cannot be undone.',
  },
};
