export const zh = {
  ...
  settings: {
    ...
    deviceManagementDesc: '管理无线设备连接和设备分组',
    addWirelessDevice: '添加无线设备',
    manageGroups: '管理分组',
    apiConfiguration: 'API 配置',
    apiConfigurationDesc: '配置视觉模型、决策模型和代理设置',
    openApiConfig: '打开配置',
    general: '通用',
    generalDesc: '语言、主题、版本信息和链接',
    language: '语言',
    theme: '主题',
    version: '版本',
    github: 'GitHub',
  ...
  workflows: {
    ...
    recordingActions: '已录制操作',
    recordingNoActions: '尚未录制任何操作。请在页面上进行交互以录制操作。',
    replay: '回放',
    replayStop: '停止回放',
    replayProgress: '回放进度',
    replayCompleted: '回放完成',
    replayFailed: '回放失败',
    replayStopped: '回放已停止',
    actionCount: '个操作',
    duration: '时长',
  ...
  plugins: {
    ...
    scanningRepos: '正在扫描仓库中的技能...',
    noSkillsFound: '未找到技能。',
    discoveryErrors: '部分仓库加载失败：',
    installedBadge: '已安装',
    view: '查看',
    install: '安装',
    uninstall: '卸载',
    uninstallSkillTitle: '卸载技能',
    uninstallSkillConfirm: '确定要卸载此技能吗？',
    // 仓库管理对话框
    addRepo: '添加仓库',
    noRepos: '未配置仓库。',
    repoUrl: '仓库',
    repoUrlPlaceholder: 'owner/repo 或 https://github.com/owner/repo',
    repoBranch: '分支',
    deleteRepoTitle: '删除仓库',
    deleteRepoConfirm: '确定要移除仓库 "{repo}" 吗？',
    // MCP 服务器
    mcpDescription: '通过 Model Context Protocol 连接的外部工具服务器。',
    addMcpServer: '添加 MCP 服务器',
    editMcpServer: '编辑 MCP 服务器',
    noMcpServers: '尚未配置 MCP 服务器。',
    mcpName: '名称',
    mcpNamePlaceholder: '例如：文件系统服务器',
    mcpType: '传输类型',
    mcpCommand: '命令',
    mcpArgs: '参数',
    mcpUrl: 'URL',
    ...
    deleteMcpConfirm: '确定要删除此 MCP 服务器吗？此操作无法撤销。',
  },
};
